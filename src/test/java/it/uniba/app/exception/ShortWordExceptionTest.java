...
/**
 * Class used to test {@code ShortWordException}.
 */
public class ShortWordExceptionTest extends Exception {
    ...
    /** method used to test if an {@code AttemptWord} is too short. */
    @Test
    public void testShortAttemptWord() {
        assertThrows(ShortWordException.class, () -> {
            new AttemptWord(new Letter[Word.getLength() - 1]);
        });

    }

    /** method used to test if a {@code SecretWord} is too short. */
    @Test
    public void testShortSecretWord() {
        assertThrows(ShortWordException.class, () -> {
